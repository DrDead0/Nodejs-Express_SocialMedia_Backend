...
import { loginUser, logoutUser, registerUser,refreshAccessToken, changeCurrentPassword, updateAvatar, getUserChannelProfile, getWatchHistory,updateCoverImage } from '../controllers/user.controllers.js';
...
userRouter.route("/history").get(verifyJWT,getWatchHistory); // get user by watch history
